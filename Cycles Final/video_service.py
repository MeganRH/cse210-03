...
class VideoService:
    ...
    def _draw_grid(self):
        """Draws a grid on the screen."""
        squares = 50
        for i in range(int(constants.MAX_X/squares)):
            pyray.draw_line(constants.MAX_X, constants.MAX_Y, constants.darkBlue,
                            (i*squares,0), (i*squares,constants.MAX_Y))
            pyray.draw_line(constants.MAX_X, constants.MAX_Y, constants.darkBlue,
                            (0, i*squares), (constants.MAX_Y, i*squares,))
    ...
    def _draw_grid():
        squares = 50
        for i in range(int(constants.MAX_X/squares)):
            pygame.draw.line(constants.display, constants.darkBlue,
                             (i*squares, 0), (i*squares, constants.MAX_Y))
            pygame.draw.line(constants.display, constants.darkBlue,
                             (0, i*squares), (constants.MAX_X, i*squares))
    '''
